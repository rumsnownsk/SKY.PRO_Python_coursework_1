...
if __name__ == "__main__":
    ...
    в модуле src/services.py
    """
    print(json.dumps(get_transactions_with_phone(df_transactions), indent=2, ensure_ascii=False))

    """
    Этот код запускает функцию 'get_transfer'
    в модуле src/services.py
    """
    print(json.dumps(get_transfer(df_transactions), indent=2, ensure_ascii=False))
